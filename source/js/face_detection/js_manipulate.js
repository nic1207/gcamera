...
function MedianFilter(){
	...
	this.filter = function(input,values){
		...
		outputData[3] = inputData[3];
		//(width-1,0)
		outputData[(0*width + width-1)*4] = inputData[(0*width + width-1)*4];
		outputData[(0*width + width-1)*4+1] = inputData[(0*width + width-1)*4+1];
		outputData[(0*width + width-1)*4+2] = inputData[(0*width + width-1)*4+2];
		outputData[(0*width + width-1)*4+3] = inputData[(0*width + width-1)*4+3];
		//(0,height-1)
		outputData[((height-1)*width + 0)*4] = inputData[((height-1)*width + 0)*4];
		outputData[((height-1)*width + 0)*4+1] = inputData[((height-1)*width + 0)*4+1];
		outputData[((height-1)*width + 0)*4+2] = inputData[((height-1)*width + 0)*4+2];
		outputData[((height-1)*width + 0)*4+3] = inputData[((height-1)*width + 0)*4+3];
		//(width-1,height-1)
		outputData[((height-1)*width + width-1)*4] = inputData[((height-1)*width + width-1)*4];
		outputData[((height-1)*width + width-1)*4+1] = inputData[((height-1)*width + width-1)*4+1];    
		outputData[((height-1)*width + width-1)*4+2] = inputData[((height-1)*width + width-1)*4+2];        
		outputData[((height-1)*width + width-1)*4+3] = inputData[((height-1)*width + width-1)*4+3]; 		
